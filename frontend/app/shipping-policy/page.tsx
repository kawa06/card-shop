  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container py-8 max-w-3xl">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-8">{t('発送・補償ポリシー', lang)}</h1>
          ...
          <section>
            ...
            <div className="grid gap-4">
              <div className="p-4 bg-white rounded-lg border border-gray-100">
                <h3 className="font-bold text-gray-900 mb-1">{t('宅急便コンパクト（ヤマト運輸）', lang)}</h3>
                <p className="text-sm opacity-80">{t('補償あり、推奨', lang)}</p>
              </div>
              <div className="p-4 bg-white rounded-lg border border-gray-100">
                <h3 className="font-bold text-gray-900 mb-1">{t('クリックポスト（日本郵便）', lang)}</h3>
          ...
          <section>
            ...
            <div className="bg-white rounded-lg border border-gray-100 p-6 space-y-4">
              ...
              <div className="grid gap-3">
                ...
                >
                  <span className="font-bold text-gray-900">{t('ヤマト運輸（宅急便コンパクト等）', lang)}</span>
                ...
                <a
                  ...
                  className="flex items-center justify-between p-4 bg-gray-50 hover:bg-gray-100 rounded-lg border border-gray-200 transition-colors group"
                >
                  <span className="font-bold text-gray-900">{t('日本郵便（クリックポスト・ゆうパック等）', lang)}</span>
                  <span className="text-xs text-yellow-400 group-hover:underline">{t('公式サイトで確認', lang)}</span>
                </a>
              </div>
            </div>
