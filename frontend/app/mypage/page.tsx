    ...
    <div className="min-h-screen bg-white">
      <div className="container py-8 max-w-3xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
          ...
          <Link href="/mypage/oripa">
            <div className="bg-gray-50 rounded-lg border border-gray-200 p-4 flex items-center gap-3 hover:border-sky-400/30 transition-colors cursor-pointer group">
              <div className="p-2 rounded-md bg-sky-400/10 text-sky-600 group-hover:bg-sky-500 group-hover:text-white transition-colors">
                <Ticket className="h-5 w-5" />
              </div>
              <div>
                <p className="text-gray-900 font-medium text-sm">保管中オリパ</p>
                <p className="text-gray-500 text-[10px]">番号のみ表示</p>
              </div>
            </div>
          </Link>
