...
export const SHIPPING_METHODS: ShippingMethodInfo[] = [
  {
    ...
    carrier: 'yamato',
    feeNote: '地域により650円〜（兵庫県発送・関西発）',
    feeNoteEn: 'From ¥650 depending on region (Hyogo / Kansai origin)',
    tracking: true,
    insurance: true,
  ...
  },
  {
    ...
    carrier: 'japan_post',
    feeNote: '配送先により1,450円〜（500gまで・日本郵便EMS料金表）',
    feeNoteEn: 'From ¥1,450 by destination (up to 500g, Japan Post EMS table)',
    tracking: true,
    insurance: true,
    insuranceDetail: '最大20,000円までの補償',
    insuranceDetailEn: 'Insurance up to ¥20,000',
    sizeLimit: '500gまで（標準）',
  ...
  },
  {
    ...
    carrier: 'yamato',
    feeNote: '配送先により1,700円〜（500gまで）',
    feeNoteEn: 'From ¥1,700 by destination (up to 500g)',
    tracking: true,
    insurance: true,
    insuranceDetail: '基本補償あり（詳細は各社規定に準ずる）',
    insuranceDetailEn: 'Basic insurance included (per carrier terms)',
