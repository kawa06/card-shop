...
ADMIN_PERMISSION_DEFINITIONS: list[tuple[str, str, str]] = [
    ...
    ("coupon.read", "クーポン閲覧", "coupons"),
    ("coupon.write", "クーポン作成・更新", "coupons"),
    ...
    ("analytics.read", "分析ダッシュボード閲覧", "analytics"),
    ("analytics.export", "分析CSV/Excel/PDF出力", "analytics"),
    ("inventory_alert.read", "在庫アラート閲覧", "inventory"),
    ("inventory_alert.write", "在庫アラート操作", "inventory"),
    ("inventory_restock.read", "補充管理閲覧", "inventory"),
    ("inventory_restock.write", "補充管理操作", "inventory"),
    ("oripa.read", "オリパ閲覧", "oripa"),
    ("oripa.create", "オリパ作成", "oripa"),
    ("oripa.update", "オリパ更新・公開", "oripa"),
    ("oripa.delete", "オリパ削除", "oripa"),
    ("oripa_entry.read", "オリパ番号閲覧", "oripa"),
    ("oripa_entry.manage", "オリパ番号生成・商品紐付け", "oripa"),
    ("shipment.read", "まとめ発送閲覧", "shipment"),
    ("shipment.create", "まとめ発送作成", "shipment"),
    ("shipment.update", "まとめ発送更新・トラッキング", "shipment"),
...
ROLE_PERMISSION_CODES: dict[str, set[str]] = {
    ...
    "admin": {
        ...
        "analytics.read",
        "analytics.export",
        "inventory_alert.read",
        "inventory_alert.write",
        "inventory_restock.read",
        "inventory_restock.write",
        "oripa.read",
        "oripa.create",
        "oripa.update",
        "oripa.delete",
