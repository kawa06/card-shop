...
ROLE_PERMISSION_CODES: dict[str, set[str]] = {
    ...
    "appraiser": {"admin.audit.read", "admin.reauth"},
    "identity_verifier": {"admin.audit.read", "admin.pii.read", "admin.reauth"},
    "inventory_manager": {"admin.audit.read", "admin.csv.export", "admin.reauth"},
    "shipping_manager": {"admin.audit.read", "admin.csv.export", "admin.reauth"},
